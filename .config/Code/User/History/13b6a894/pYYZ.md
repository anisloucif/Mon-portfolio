...
Titulaire d'un Baccalauréat Professionnel en **Gestion-Administration** obtenu avec la mention "Bien" en 2022, j'ai initialement poursuivi mes études en intégrant le BTS **Gestion de la PME** (GPME). Après avoir validé ma première année, j'ai pris la décision d'interrompre cette formation en décembre 2023, au cours de ma deuxième année. Ce choix mûrement rélfléchi était motivé par une volonté de réorientation afin d'évoluer vers un secteur en parfaite adéquation avec mes ambitions : l'informatique. 

Afin de mener à bien cette reconversion professionnelle, j'ai étudié en détail les différentes poursuites d'études possibles dans ce domaine, notamment les parcours suivants :
...
Fort de cette analyse, j'ai finalisé ma reconversion professionnelle en Septembre 2025 en intégrant le **BTS SIO** au sein du **lycée Léonard de Vinci à Melun**. J'ai par la suite opté pour la spécialité **SLAM** afin d'approfondir mes compétences techniques en développement d'applications notamment,véritable projet de carrière.
